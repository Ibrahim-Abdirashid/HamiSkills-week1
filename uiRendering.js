...
const renderProduct = (product) => {
    ...
    productElement.innerHTML = `
        <div class="product-image h-48">
            <img src="${imageUrl}" alt="${product.name}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='https://placehold.co/400x300/cccccc/333333?text=Sawir+Ma+Jiro';">
        </div>
